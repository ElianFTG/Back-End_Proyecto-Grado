export const resetPasswordTemplate = (recipientName: string, temporaryPassword: string): string => {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
            ...
            <p style="color: #666; font-size: 16px;">Tu contraseña para el sistema SICME Electrik ha sido reestablecida. A continuación encontrarás tu nueva contraseña de acceso:</p>
            ...
            <div style="background: #fff3cd; border: 1px solid #ffc107; border-radius: 8px; padding: 15px; margin: 20px 0;">
                <p style="color: #856404; margin: 0;"><strong>⚠️ Importante:</strong> Al iniciar sesión, el sistema te pedirá cambiar tu contraseña por una segura.</p>
            </div>
